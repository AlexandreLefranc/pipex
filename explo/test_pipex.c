...
// clangc explo/test_pipex.c -Ilibft/include -L. -lft && ./a.out a cat wc d
// clangc explo/test_pipex.c -Ilibft/include -L. -lft && ./a.out infile2.txt "cat -e" "wc -l" b
...
int	main(int argc, char **argv, char **envp)
{
	...
	cmds = argv_fullpath(argc, argv, path);
	ft_strtabprint(cmds);
	// _pipex();
	return (0);
}
